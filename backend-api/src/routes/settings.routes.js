  ...
  try {
    await queryTenant(tenantId, `
      UPDATE clinic_settings SET
        ...
        patient_login_enabled     = COALESCE($19, patient_login_enabled),
        queue_display_enabled     = COALESCE($20, queue_display_enabled),
        website_enabled           = COALESCE($21, website_enabled),
        website_tagline           = COALESCE($22, website_tagline),
        website_about             = COALESCE($23, website_about),
        website_hours             = COALESCE($24, website_hours),
        website_map_url           = COALESCE($25, website_map_url),
    ...
    `, [
      ...
      patient_login_enabled     != null ? patient_login_enabled     : null,
